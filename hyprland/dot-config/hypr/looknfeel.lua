-- Look & feel (migrated from looknfeel.conf)
-- https://wiki.hypr.land/Configuring/Basics/Variables/
---@module 'hl'

-- Border colors (gradient uses the { colors = {...}, angle = N } form)
...
hl.animation({ leaf = "windowsMove",   enabled = false, speed = 3.5,  bezier = "easeOutQuint", style = "slidefadevert" })
...
hl.animation({ leaf = "workspaces",    enabled = false, speed = 3,    bezier = "easeOutQuint", style = "slidefadevert" })
hl.animation({ leaf = "zoomFactor",    enabled = false, speed = 10,   bezier = "quick" })
